#!/usr/bin/python3
"""Function that defines unit tests for models/user.py.
...
class TestUser_instantiation(unittest.TestCase):
    """Unit tests for testing instantiation of User class."""
...
class TestUser_save(unittest.TestCase):
    """Unit tests for testing save method of User class."""
...
class TestUser_to_dict(unittest.TestCase):
    """Unit tests for testing to_dict method of User class."""
