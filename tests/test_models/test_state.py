#!/usr/bin/python3
"""Function that defines unit tests for models/state.py.
...
class TestState_instantiation(unittest.TestCase):
    """Unit tests for testing instantiation of State class."""
...
class TestState_save(unittest.TestCase):
    """Unit tests for testing save method of State class."""
...
class TestState_to_dict(unittest.TestCase):
    """Unit tests for testing to_dict method of State class."""
